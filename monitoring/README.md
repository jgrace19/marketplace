...
Monitor that catches unexpected 500s from `GET /api/recommendations`. It alerts
...
## Generate traffic for a demo

When the endpoint is returning errors, click **Today's Deals** in the app, or:
